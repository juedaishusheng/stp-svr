...
EL.paging = (function() {
  ...
  function _paging(req) {
    var argsBuilder = req.argsBuilder ? req.argsBuilder() : {},
...
EL._table = (function () {
  ...
  function _reset(req) {
    var selector = req.selector,
      width = (typeof req.width === 'number' ? req.width : $(req.width).width()) || req.tableWidth;
...
EL.scroll = (function () {
  ...
  function _search(req) {
    var args = req.argsBuilder ? req.argsBuilder() : {};
