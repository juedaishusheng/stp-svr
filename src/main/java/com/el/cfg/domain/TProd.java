...
public class TProd implements Serializable {
    ...
    /**
     *  成品单位 - T_PROD.PROD_UOM
     */
    private String prodUom;

    /**
     *  版数 - T_PROD.VERSION_NUM
     */
    private Short versionNum;

    /**
     *  次数 - T_PROD.REPEAT_NUM
     */
    private Short repeatNum;

    /**
     *  印张数 - T_PROD.IMPRESSION_CNT
     */
    ...
    /**
     *  锁定人ID - T_PROD.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_PROD.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_PROD.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_PROD.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_PROD.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_PROD.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_PROD.DATA_VERSION
     */
    private Long dataVersion;

    /**
     *  公司ID 对应T_OU.ID - T_PROD.OU_ID
     */
    private Long ouId;
    ...
    /**
     *  产品编号 - T_PROD.PROD_CODE
     */
    private String prodCode;

    /**
     *  产品名称 - T_PROD.PROD_NAME
     */
    ...
    /**
     *  产品大类 - T_PROD.PROD_CAT1
     */
    private String prodCat1;

    /**
     *  产品小类 - T_PROD.PROD_CAT2
     */
    private String prodCat2;

    /**
     *  开本 - T_PROD.PROD_FORMAT
     */
    private String prodFormat;

    /**
     *  成品高度 - T_PROD.PROD_HEIGHT
     */
    private BigDecimal prodHeight;

    /**
     *  成品宽度 - T_PROD.PROD_WIDTH
     */
    private BigDecimal prodWidth;

    /**
     *  成品厚度 - T_PROD.PROD_THICK
     */
    private BigDecimal prodThick;

    /**
     *  成品重量 - T_PROD.PROD_WEIGHT
     */
    private BigDecimal prodWeight;

    /**
     *  前勒口宽度 - T_PROD.FRONT_FLAP_WIDTH
     */
    private BigDecimal frontFlapWidth;

    /**
     *  后勒口宽度 - T_PROD.BACK_FLAP_WIDTH
     */
    private BigDecimal backFlapWidth;

    /**
     *  装订方式1 - T_PROD.BIND_TYPE1
     */
    private String bindType1;

    /**
     *  装订方式2 - T_PROD.BIND_TYPE2
     */
    private String bindType2;

    /**
     *  定价 - T_PROD.SALE_PRICE
     */
    private BigDecimal salePrice;

    /**
     *  色彩标准 - T_PROD.COLOR_STANDARD
     */
    private String colorStandard;

    /**
     *  追色标准 - T_PROD.COLORMATCH_STANDARD
     */
    private String colormatchStandard;

    /**
     *  是否套装 0:否 1:是 - T_PROD.SET_FLAG
     */
    private String setFlag;

    /**
     *  是否FSC 0-否，1-是 - T_PROD.FSC_FLAG
     */
    private Short fscFlag;

    /**
     *  是否绿色 0-否，1-是 - T_PROD.GREEN_FLAG
     */
    private Short greenFlag;

    /**
     *  是否保密 0-否，1-是 - T_PROD.SECRET_FLAG
     */
    private Short secretFlag;

    /**
     *  特殊要求 - T_PROD.SPECIAL_DEMAND
     */
    private String specialDemand;

    /**
     *  ISBN/ISSN - T_PROD.PROD_ISBN
     */
    ...
    /**
     *  期数 - T_PROD.PROD_PERIOD
     */
    private String prodPeriod;

    /**
     *  批次 - T_PROD.PROD_BATCH
     */
    private String prodBatch;

    /**
     *  预估印量 - T_PROD.ESTI_PRINT_QTY
     */
    private Long estiPrintQty;

    /**
     *  书芯厚度 - T_PROD.WITHIN_THICK
     */
    ...
    /**
     *  印前单产品编号 - T_PROD.PREPRESS_DOC_NO
     */
    private String prepressDocNo;

    /**
     *  生产质量等级 A/B/C - T_PROD.QUALITY_LEVEL
     */
    private String qualityLevel;

    /**
     *  印刷难度等级 A/B/C - T_PROD.PRINT_DIFF_LEVEL
     */
    private String printDiffLevel;

    /**
     *  装订难度等级 A/B/C - T_PROD.BIND_DIFF_LEVEL
     */
    private String bindDiffLevel;

    /**
     *  最后生产工厂ID - T_PROD.LAST_FACT_ID
     */
    ...
    /**
     *  客户方编码 - T_PROD.CUST_PROD_NO
     */
    private String custProdNo;

    /**
     *  装订备注 - T_PROD.BIND_DESC
     */
    private String bindDesc;

    /**
     *  删除标记 - T_PROD.DELETE_FLAG
     */
    private Short deleteFlag;

    /**
     *  版本号描述 - T_PROD.VERSION_DESC
     */
