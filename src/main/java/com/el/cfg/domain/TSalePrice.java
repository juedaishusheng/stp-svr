...
public class TSalePrice implements Serializable {
    /**
     *  null - T_SALE_PRICE.ID
     */
    private Long id;

    /**
     *  null - T_SALE_PRICE.OU_ID
     */
    private Long ouId;

    /**
     *  null - T_SALE_PRICE.MCU_ID
     */
    private Long mcuId;

    /**
     *  商品ID - T_SALE_PRICE.ITEM_ID
     */
    private Long itemId;

    /**
     *  外部编号 - T_SALE_PRICE.OUTER_ID
     */
    private Long outerId;

    /**
     *  外部编号2 - T_SALE_PRICE.OUTER_ID2
     */
    private String outerId2;

    /**
     *  外部编号3 - T_SALE_PRICE.OUTER_ID3
     */
    private String outerId3;

    /**
     *  客户组ID - T_SALE_PRICE.CUST_GROUP
     */
    private Long custGroup;

    /**
     *  地址号 - T_SALE_PRICE.ADDR_NO
     */
    private Long addrNo;

    /**
     *  价格 - T_SALE_PRICE.PRICE
     */
    private BigDecimal price;

    /**
     *  价格单位 - T_SALE_PRICE.PRICE_UOM
     */
    private String priceUom;

    /**
     *  币种 - T_SALE_PRICE.CURR
     */
    private String curr;

    /**
     *  起始时间 - T_SALE_PRICE.BEGIN_DATE
     */
    private Date beginDate;

    /**
     *  截止时间 - T_SALE_PRICE.END_DATE
     */
    private Date endDate;

    /**
     *  锁定人ID - T_SALE_PRICE.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_SALE_PRICE.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_SALE_PRICE.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_SALE_PRICE.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_SALE_PRICE.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_SALE_PRICE.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_SALE_PRICE.DATA_VERSION
     */
