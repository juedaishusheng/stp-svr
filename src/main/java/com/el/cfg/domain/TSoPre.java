...
public class TSoPre implements Serializable {
    /**
     *  null - T_SO_PRE.ID
     */
    private Long id;
    ...
    /**
     *  订单产品细表ID - T_SO_PRE.T_SO_PROD_ID
     */
    ...
    /**
     *  产品部件ID - T_SO_PRE.PROD_PART_ID
     */
    private Long prodPartId;

    /**
     *  工艺ID - T_SO_PRE.ROUTE_ID
     */
    private Long routeId;

    /**
     *  工序ID - T_SO_PRE.PROCESS_ID
     */
    private Long processId;

    /**
     *  产品工艺段细表ID - T_SO_PRE.PROD_ROUTE_ID
     */
    private Long prodRouteId;

    /**
     *  产品工序细表ID - T_SO_PRE.PROD_PROCESS_ID
     */
    private Long prodProcessId;

    /**
     *  项目名称 - T_SO_PRE.ITEM_NAME
     */
    private String itemName;

    /**
     *  数量 - T_SO_PRE.ITEM_QTY
     */
    private Long itemQty;

    /**
     *  单位 - T_SO_PRE.ITEM_UOM
     */
    private String itemUom;

    /**
     *  加工费 - T_SO_PRE.MANU_FEE
     */
    private BigDecimal manuFee;

    /**
     *  材料料号ID - T_SO_PRE.MATER_ID
     */
    private Long materId;

    /**
     *  材料费 - T_SO_PRE.MATER_FEE
     */
    private BigDecimal materFee;

    /**
     *  本币币种 - T_SO_PRE.HOME_CURR_CODE
     */
    private String homeCurrCode;

    /**
     *  原币币种 - T_SO_PRE.FORE_CURR_CODE
     */
    private String foreCurrCode;

    /**
     *  汇率 - T_SO_PRE.CURR_RATE
     */
    private BigDecimal currRate;

    /**
     *  核算单价 - T_SO_PRE.CALC_PRICE
     */
    private BigDecimal calcPrice;

    /**
     *  原币核算单价 - T_SO_PRE.CURR_CALC_PRICE
     */
    private BigDecimal currCalcPrice;

    /**
     *  报价单价 - T_SO_PRE.QUOTE_PRICE
     */
    private BigDecimal quotePrice;

    /**
     *  原币报价单价 - T_SO_PRE.CURR_QUOTE_PRICE
     */
    private BigDecimal currQuotePrice;

    /**
     *  核算金额 - T_SO_PRE.CALC_AMT
     */
    private BigDecimal calcAmt;

    /**
     *  原币核算金额 - T_SO_PRE.CURR_CALC_AMT
     */
    private BigDecimal currCalcAmt;

    /**
     *  报价金额 - T_SO_PRE.QUOTE_AMT
     */
    private BigDecimal quoteAmt;

    /**
     *  原币报价金额 - T_SO_PRE.CURR_QUOTE_AMT
     */
    private BigDecimal currQuoteAmt;

    /**
     *  价格类型 初始/变更 - T_SO_PRE.PRICE_TYPE
     */
    private String priceType;

    /**
     *  价格确认信息 - T_SO_PRE.PRICE_CONFIRM_DESC
     */
    ...
    /**
     *  锁定人ID - T_SO_PRE.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_SO_PRE.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_SO_PRE.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_SO_PRE.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_SO_PRE.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_SO_PRE.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_SO_PRE.DATA_VERSION
     */
