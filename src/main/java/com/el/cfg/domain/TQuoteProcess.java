...
public class TQuoteProcess implements Serializable {
    /**
     *  null - T_QUOTE_PROCESS.ID
     */
    private Long id;

    /**
     *  报价单ID - T_QUOTE_PROCESS.QUOTE_ID
     */
    private Long quoteId;

    /**
     *  行号 - T_QUOTE_PROCESS.LINE_NO
     */
    private Long lineNo;

    /**
     *  工艺ID - T_QUOTE_PROCESS.ROUTE_ID
     */
    private Long routeId;

    /**
     *  工序ID - T_QUOTE_PROCESS.PROCESS_ID
     */
    private Long processId;

    /**
     *  产品ID - T_QUOTE_PROCESS.PROD_ID
     */
    private Long prodId;

    /**
     *  产品部件ID - T_QUOTE_PROCESS.PROD_PART_ID
     */
    private Long prodPartId;

    /**
     *  数量 - T_QUOTE_PROCESS.ITEM_QTY
     */
    private BigDecimal itemQty;

    /**
     *  单位 - T_QUOTE_PROCESS.ITEM_UOM
     */
    private String itemUom;

    /**
     *  发货日期 - T_QUOTE_PROCESS.TRANS_TS
     */
    private Date transTs;

    /**
     *  备注 - T_QUOTE_PROCESS.REMARK
     */
    private String remark;

    /**
     *  本币币种 - T_QUOTE_PROCESS.HOME_CURR_CODE
     */
    private String homeCurrCode;

    /**
     *  原币币种 - T_QUOTE_PROCESS.FORE_CURR_CODE
     */
    private String foreCurrCode;

    /**
     *  汇率 - T_QUOTE_PROCESS.CURR_RATE
     */
    private BigDecimal currRate;

    /**
     *  核算单价 - T_QUOTE_PROCESS.CALC_PRICE
     */
    private BigDecimal calcPrice;

    /**
     *  原币核算单价 - T_QUOTE_PROCESS.CURR_CALC_PRICE
     */
    private BigDecimal currCalcPrice;

    /**
     *  报价单价 - T_QUOTE_PROCESS.QUOTE_PRICE
     */
    private BigDecimal quotePrice;

    /**
     *  原币报价单价 - T_QUOTE_PROCESS.CURR_QUOTE_PRICE
     */
    private BigDecimal currQuotePrice;

    /**
     *  核算金额 - T_QUOTE_PROCESS.CALC_AMT
     */
    private BigDecimal calcAmt;

    /**
     *  原币核算金额 - T_QUOTE_PROCESS.CURR_CALC_AMT
     */
    private BigDecimal currCalcAmt;

    /**
     *  报价金额 - T_QUOTE_PROCESS.QUOTE_AMT
     */
    private BigDecimal quoteAmt;

    /**
     *  原币报价金额 - T_QUOTE_PROCESS.CURR_QUOTE_AMT
     */
    private BigDecimal currQuoteAmt;

    /**
     *  价格类型 初始/变更 - T_QUOTE_PROCESS.PRICE_TYPE
     */
    private String priceType;

    /**
     *  价格确认信息 - T_QUOTE_PROCESS.PRICE_CONFIRM_DESC
     */
    private String priceConfirmDesc;

    /**
     *  锁定人ID - T_QUOTE_PROCESS.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_QUOTE_PROCESS.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_QUOTE_PROCESS.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_QUOTE_PROCESS.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_QUOTE_PROCESS.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_QUOTE_PROCESS.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_QUOTE_PROCESS.DATA_VERSION
     */
