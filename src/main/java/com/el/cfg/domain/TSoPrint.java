...
public class TSoPrint implements Serializable {
    /**
     *  null - T_SO_PRINT.ID
     */
    private Long id;
    ...
    /**
     *  订单产品细表ID - T_SO_PRINT.T_SO_PROD_ID
     */
    private Long tSoProdId;

    /**
     *  行号 - T_SO_PRINT.LINE_NO
     */
    private BigDecimal lineNo;

    /**
     *  产品部件ID - T_SO_PRINT.PROD_PART_ID
     */
    private Long prodPartId;

    /**
     *  工艺ID - T_SO_PRINT.ROUTE_ID
     */
    private Long routeId;

    /**
     *  工序ID - T_SO_PRINT.PROCESS_ID
     */
    private Long processId;

    /**
     *  产品工艺段细表ID - T_SO_PRINT.PROD_ROUTE_ID
     */
    private Long prodRouteId;

    /**
     *  产品工序细表ID - T_SO_PRINT.PROD_PROCESS_ID
     */
    private Long prodProcessId;

    /**
     *  项目名称 - T_SO_PRINT.ITEM_NAME
     */
    private String itemName;

    /**
     *  数量 - T_SO_PRINT.ITEM_QTY
     */
    private Long itemQty;

    /**
     *  单位 - T_SO_PRINT.ITEM_UOM
     */
    private String itemUom;

    /**
     *  加工费 - T_SO_PRINT.MANU_FEE
     */
    private BigDecimal manuFee;

    /**
     *  材料料号ID - T_SO_PRINT.MATER_ID
     */
    private Long materId;

    /**
     *  材料费 - T_SO_PRINT.MATER_FEE
     */
    private BigDecimal materFee;

    /**
     *  本币币种 - T_SO_PRINT.HOME_CURR_CODE
     */
    private String homeCurrCode;

    /**
     *  原币币种 - T_SO_PRINT.FORE_CURR_CODE
     */
    private String foreCurrCode;

    /**
     *  汇率 - T_SO_PRINT.CURR_RATE
     */
    private BigDecimal currRate;

    /**
     *  核算单价 - T_SO_PRINT.CALC_PRICE
     */
    private BigDecimal calcPrice;

    /**
     *  原币核算单价 - T_SO_PRINT.CURR_CALC_PRICE
     */
    private BigDecimal currCalcPrice;

    /**
     *  报价单价 - T_SO_PRINT.QUOTE_PRICE
     */
    private BigDecimal quotePrice;

    /**
     *  原币报价单价 - T_SO_PRINT.CURR_QUOTE_PRICE
     */
    private BigDecimal currQuotePrice;

    /**
     *  核算金额 - T_SO_PRINT.CALC_AMT
     */
    private BigDecimal calcAmt;

    /**
     *  原币核算金额 - T_SO_PRINT.CURR_CALC_AMT
     */
    private BigDecimal currCalcAmt;

    /**
     *  报价金额 - T_SO_PRINT.QUOTE_AMT
     */
    private BigDecimal quoteAmt;

    /**
     *  原币报价金额 - T_SO_PRINT.CURR_QUOTE_AMT
     */
    private BigDecimal currQuoteAmt;

    /**
     *  价格类型 初始/变更 - T_SO_PRINT.PRICE_TYPE
     */
    private String priceType;

    /**
     *  价格确认信息 - T_SO_PRINT.PRICE_CONFIRM_DESC
     */
    private String priceConfirmDesc;

    /**
     *  备注 - T_SO_PRINT.REMARK
     */
    private String remark;

    /**
     *  锁定人ID - T_SO_PRINT.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_SO_PRINT.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_SO_PRINT.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_SO_PRINT.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_SO_PRINT.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_SO_PRINT.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_SO_PRINT.DATA_VERSION
     */
    ...
    public Long getProdProcessId() {
        return prodProcessId;
    }

    public void setProdProcessId(Long prodProcessId) {
    ...
    public BigDecimal getManuFee() {
        return manuFee;
    }

    public void setManuFee(BigDecimal manuFee) {
        this.manuFee = manuFee;
    }
    ...
    public BigDecimal getMaterFee() {
        return materFee;
    }

    public void setMaterFee(BigDecimal materFee) {
        this.materFee = materFee;
    }
    ...
    public String toString() {
        ...
        sb.append(", prodProcessId=").append(prodProcessId);
        sb.append(", itemName=").append(itemName);
        sb.append(", itemQty=").append(itemQty);
        sb.append(", itemUom=").append(itemUom);
        sb.append(", manuFee=").append(manuFee);
        sb.append(", materId=").append(materId);
        sb.append(", materFee=").append(materFee);
