...
public class TOrgProdProcess implements Serializable {
    /**
     *  null - T_ORG_PROD_PROCESS.ID
     */
    private Long id;

    /**
     *  产品ID - T_ORG_PROD_PROCESS.PROD_ID
     */
    private Long prodId;

    /**
     *  部件ID - T_ORG_PROD_PROCESS.PART_ID
     */
    private Long partId;

    /**
     *  部件名称 - T_ORG_PROD_PROCESS.PART_NAME
     */
    private String partName;

    /**
     *  产品工艺段ID - T_ORG_PROD_PROCESS.PRODROUTE_ID
     */
    private Long prodrouteId;

    /**
     *  工艺段说明 - T_ORG_PROD_PROCESS.ROUTE_DESC
     */
    private String routeDesc;

    /**
     *  工序ID - T_ORG_PROD_PROCESS.PROCESS_ID
     */
    private Long processId;

    /**
     *  工序顺序号 - T_ORG_PROD_PROCESS.PROCESS_SORTNO
     */
    private Long processSortno;

    /**
     *  工序编号 - T_ORG_PROD_PROCESS.PROCESS_CODE
     */
    private String processCode;

    /**
     *  下道工序顺序号 - T_ORG_PROD_PROCESS.NEXT_SORT_NO
     */
    private Long nextSortNo;

    /**
     *  作业机型 - T_ORG_PROD_PROCESS.MACHINE_TYPE
     */
    private String machineType;

    /**
     *  生产编号 - T_ORG_PROD_PROCESS.MANU_NO
     */
    private String manuNo;

    /**
     *  P数 - T_ORG_PROD_PROCESS.PAGE_CNT
     */
    private Long pageCnt;

    /**
     *  贴数 - T_ORG_PROD_PROCESS.SIGN_CNT
     */
    private Long signCnt;

    /**
     *  页数说明 - T_ORG_PROD_PROCESS.PAGE_DESC
     */
    private String pageDesc;

    /**
     *  每贴P数 - T_ORG_PROD_PROCESS.PAGECNT_PER_SIGN
     */
    private Short pagecntPerSign;

    /**
     *  拼数 - T_ORG_PROD_PROCESS.SETS_CNT
     */
    private Short setsCnt;

    /**
     *  拼式 - T_ORG_PROD_PROCESS.SETS_METHOD
     */
    private String setsMethod;

    /**
     *  印刷方式 - T_ORG_PROD_PROCESS.PRINT_METHOD
     */
    private String printMethod;

    /**
     *  原色正 - T_ORG_PROD_PROCESS.COLORCNT_FRONT
     */
    private Short colorcntFront;

    /**
     *  原色反 - T_ORG_PROD_PROCESS.COLORCNT_BACK
     */
    private Short colorcntBack;

    /**
     *  专色正 - T_ORG_PROD_PROCESS.SCOLORCNT_FRONT
     */
    private Short scolorcntFront;

    /**
     *  专色反 - T_ORG_PROD_PROCESS.SCOLORCNT_BACK
     */
    private Short scolorcntBack;

    /**
     *  原色说明 - T_ORG_PROD_PROCESS.COLOR_DESC
     */
    private String colorDesc;

    /**
     *  专色说明 - T_ORG_PROD_PROCESS.SCOLOR_DESC
     */
    private String scolorDesc;

    /**
     *  联机上光 - T_ORG_PROD_PROCESS.UNIONVANISH
     */
    private String unionvanish;

    /**
     *  上光面数 共用：加工面数 - T_ORG_PROD_PROCESS.UNIONVANISH_FACES
     */
    private String unionvanishFaces;

    /**
     *  上光版数 - T_ORG_PROD_PROCESS.UNIONVANISH_PLATECNT
     */
    private Short unionvanishPlatecnt;

    /**
     *  开纸方式 即上机规格 - T_ORG_PROD_PROCESS.PAPER_FORMAT
     */
    private String paperFormat;

    /**
     *  开纸高度 - T_ORG_PROD_PROCESS.PRINTPAPER_HEIGHT
     */
    private Short printpaperHeight;

    /**
     *  开纸宽度 - T_ORG_PROD_PROCESS.PRINTPAPER_WIDTH
     */
    private Short printpaperWidth;

    /**
     *  料源 - T_ORG_PROD_PROCESS.MATERIAL_SOURCE
     */
    private String materialSource;

    /**
     *  物料ID - T_ORG_PROD_PROCESS.MATERIAL_ID
     */
    private Long materialId;

    /**
     *  用料数量 - T_ORG_PROD_PROCESS.MATERIAL_QTY
     */
    private BigDecimal materialQty;

    /**
     *  用料单位 - T_ORG_PROD_PROCESS.MATERIAL_UOM
     */
    private String materialUom;

    /**
     *  版型 - T_ORG_PROD_PROCESS.PLATE_TYPE
     */
    private String plateType;

    /**
     *  每贴版数 - T_ORG_PROD_PROCESS.PLATECNT_PER_SIGN
     */
    private Short platecntPerSign;

    /**
     *  总版数 - T_ORG_PROD_PROCESS.PLATE_CNT
     */
    private Short plateCnt;

    /**
     *  制版套数 - T_ORG_PROD_PROCESS.PLATE_SETCNT
     */
    private Short plateSetcnt;

    /**
     *  网型 - T_ORG_PROD_PROCESS.SCREEN_TYPE
     */
    private String screenType;

    /**
     *  线数 - T_ORG_PROD_PROCESS.SCREEN_DPI
     */
    private String screenDpi;

    /**
     *  正数 - T_ORG_PROD_PROCESS.MANU_QTY
     */
    private Long manuQty;

    /**
     *  印刷加放 - T_ORG_PROD_PROCESS.PRINT_ADDUP
     */
    private BigDecimal printAddup;

    /**
     *  装订加放 - T_ORG_PROD_PROCESS.BIND_ADDUP
     */
    private BigDecimal bindAddup;

    /**
     *  每贴用纸令数 - T_ORG_PROD_PROCESS.REAM_PER_SIGN
     */
    private BigDecimal reamPerSign;

    /**
     *  总用纸令数 - T_ORG_PROD_PROCESS.REAM_CNT
     */
    private BigDecimal reamCnt;

    /**
     *  纸张核算用量 - T_ORG_PROD_PROCESS.PAPER_USAGE
     */
    private BigDecimal paperUsage;

    /**
     *  客户要求用量 - T_ORG_PROD_PROCESS.CUSTAGREE_USAGE
     */
    private BigDecimal custagreeUsage;

    /**
     *  纸张利用率 - T_ORG_PROD_PROCESS.PAPER_UTILIZE_RATIO
     */
    private BigDecimal paperUtilizeRatio;

    /**
     *  加工难度等级 - T_ORG_PROD_PROCESS.DIFF_LEVEL
     */
    private String diffLevel;

    /**
     *  墨量大小 - T_ORG_PROD_PROCESS.INKQTY_DESC
     */
    private String inkqtyDesc;

    /**
     *  加工面积 - T_ORG_PROD_PROCESS.PROCESS_AREA
     */
    private BigDecimal processArea;

    /**
     *  加工单位 - T_ORG_PROD_PROCESS.PROCESS_UOM
     */
    private String processUom;

    /**
     *  加工数量 - T_ORG_PROD_PROCESS.PROCESS_QTY
     */
    private Long processQty;

    /**
     *  加工开数 - T_ORG_PROD_PROCESS.PROCESS_FORMAT
     */
    private String processFormat;

    /**
     *  工艺要求 - T_ORG_PROD_PROCESS.PROCESS_DEMAND
     */
    private String processDemand;

    /**
     *  加工说明 - T_ORG_PROD_PROCESS.PROCESS_DESC
     */
    private String processDesc;

    /**
     *  加工后每贴P数 - T_ORG_PROD_PROCESS.AFTERPROCESS_PAGEPERSIGN
     */
    private Short afterprocessPagepersign;

    /**
     *  勒口尺寸 - T_ORG_PROD_PROCESS.FLAP_SIZE
     */
    private Short flapSize;

    /**
     *  模具版数 - T_ORG_PROD_PROCESS.MOLD_CNT
     */
    private Short moldCnt;

    /**
     *  模具费用 - T_ORG_PROD_PROCESS.MOLD_AMT
     */
    private BigDecimal moldAmt;

    /**
     *  参考样 - T_ORG_PROD_PROCESS.SAMPLE
     */
    private String sample;

    /**
     *  备注 - T_ORG_PROD_PROCESS.REMARK
     */
    private String remark;

    /**
     *  锁定人ID - T_ORG_PROD_PROCESS.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_ORG_PROD_PROCESS.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_ORG_PROD_PROCESS.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_ORG_PROD_PROCESS.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_ORG_PROD_PROCESS.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_ORG_PROD_PROCESS.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_ORG_PROD_PROCESS.DATA_VERSION
     */
