...
public class TSoPaper implements Serializable {
    /**
     *  null - T_SO_PAPER.ID
     */
    private Long id;
    ...
    /**
     *  行号 - T_SO_PAPER.LINE_NO
     */
    private Long lineNo;

    /**
     *  产品部件ID 对应T_SO_PART.ID - T_SO_PAPER.PROD_PART_ID
     */
    private Long prodPartId;

    /**
     *  纸张种类 0:纸张 1:辅料 - T_SO_PAPER.PAPER_TYPE
     */
    private Short paperType;

    /**
     *  纸张料号ID - T_SO_PAPER.PAPER_ITEM_ID
     */
    private Long paperItemId;

    /**
     *  单位 - T_SO_PAPER.ITEM_UOM
     */
    private String itemUom;

    /**
     *  本币币种 - T_SO_PAPER.HOME_CURR_CODE
     */
    private String homeCurrCode;

    /**
     *  原币币种 - T_SO_PAPER.FORE_CURR_CODE
     */
    private String foreCurrCode;

    /**
     *  汇率 - T_SO_PAPER.CURR_RATE
     */
    private BigDecimal currRate;

    /**
     *  核算单价 - T_SO_PAPER.CALC_PRICE
     */
    private BigDecimal calcPrice;

    /**
     *  原币核算单价 - T_SO_PAPER.CURR_CALC_PRICE
     */
    private BigDecimal currCalcPrice;

    /**
     *  报价单价 - T_SO_PAPER.QUOTE_PRICE
     */
    private BigDecimal quotePrice;

    /**
     *  原币报价单价 - T_SO_PAPER.CURR_QUOTE_PRICE
     */
    private BigDecimal currQuotePrice;

    /**
     *  核算金额 - T_SO_PAPER.CALC_AMT
     */
    private BigDecimal calcAmt;

    /**
     *  原币核算金额 - T_SO_PAPER.CURR_CALC_AMT
     */
    private BigDecimal currCalcAmt;

    /**
     *  报价金额 - T_SO_PAPER.QUOTE_AMT
     */
    private BigDecimal quoteAmt;

    /**
     *  原币报价金额 - T_SO_PAPER.CURR_QUOTE_AMT
     */
    private BigDecimal currQuoteAmt;

    /**
     *  价格类型 初始/变更 - T_SO_PAPER.PRICE_TYPE
     */
    private String priceType;

    /**
     *  价格确认信息 - T_SO_PAPER.PRICE_CONFIRM_DESC
     */
    private String priceConfirmDesc;

    /**
     *  备注 - T_SO_PAPER.REMARK
     */
    private String remark;

    /**
     *  锁定人ID - T_SO_PAPER.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_SO_PAPER.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_SO_PAPER.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_SO_PAPER.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_SO_PAPER.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_SO_PAPER.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_SO_PAPER.DATA_VERSION
     */
    private Long dataVersion;

    /**
     *  报价单ID - T_SO_PAPER.SO_ID
     */
    private Long soId;

    /**
     *  工艺ID - T_SO_PAPER.ROUTE_ID
     */
    private Long routeId;

    /**
     *  工序ID - T_SO_PAPER.PROCESS_ID
     */
    private Long processId;

    /**
     *  产品ID 对应T_SO_PROD.ID - T_SO_PAPER.PROD_ID
     */
    private Long prodId;

    /**
     *  数量 - T_SO_PAPER.ITEM_QTY
     */
