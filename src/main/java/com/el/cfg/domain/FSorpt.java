...
public class FSorpt implements Serializable {
    /**
     *  null - F_SORPT.ID
     */
    private Long id;
    ...
    /**
     *  订单生产表ID - F_SORPT.SO_MANU_ID
     */
    private Long soManuId;

    /**
     *  产品ID - F_SORPT.PROD_ID
     */
    private Long prodId;

    /**
     *  部件ID - F_SORPT.PART_ID
     */
    private Long partId;
    ...
    /**
     *  报工人ID - F_SORPT.RPTER_ID
     */
    private Long rpterId;

    /**
     *  报工人姓名 - F_SORPT.RPTER_NAME
     */
    private String rpterName;

    /**
     *  报工类型 - F_SORPT.RPT_TYPE
     */
    private String rptType;

    /**
     *  报工数量 - F_SORPT.RPT_QTY
     */
    private Long rptQty;
    ...
    /**
     *  锁定人ID - F_SORPT.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - F_SORPT.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - F_SORPT.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - F_SORPT.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - F_SORPT.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - F_SORPT.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - F_SORPT.DATA_VERSION
     */
