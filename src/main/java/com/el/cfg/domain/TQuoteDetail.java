...
public class TQuoteDetail implements Serializable {
    /**
     *  null - T_QUOTE_DETAIL.ID
     */
    private Long id;

    /**
     *  报价单ID - T_QUOTE_DETAIL.QUOTE_ID
     */
    private Long quoteId;

    /**
     *  报价单行号 - T_QUOTE_DETAIL.LINE_NO
     */
    private Long lineNo;

    /**
     *  行类型 - T_QUOTE_DETAIL.LINE_TYPE
     */
    private String lineType;

    /**
     *  产品ID 对应T_PROD.ID - T_QUOTE_DETAIL.PROD_ID
     */
    private Long prodId;

    /**
     *  是否产品变更  0:否 1:是 - T_QUOTE_DETAIL.CHANGE_FLAG
     */
    private String changeFlag;

    /**
     *  版数 - T_QUOTE_DETAIL.VERSION_NUM
     */
    private Short versionNum;

    /**
     *  次数 - T_QUOTE_DETAIL.REPEAT_NUM
     */
    private Short repeatNum;

    /**
     *  订单状态 - T_QUOTE_DETAIL.QUOTE_STATUS
     */
    private String quoteStatus;

    /**
     *  分单状态 - T_QUOTE_DETAIL.DIST_STATUS
     */
    private String distStatus;

    /**
     *  结算状态 - T_QUOTE_DETAIL.SETTLE_STATUS
     */
    private String settleStatus;

    /**
     *  信用状态 - T_QUOTE_DETAIL.CREDIT_STATUS
     */
    private String creditStatus;

    /**
     *  本币币种 - T_QUOTE_DETAIL.HOME_CURR_CODE
     */
    private String homeCurrCode;

    /**
     *  原币币种 - T_QUOTE_DETAIL.FORE_CURR_CODE
     */
    private String foreCurrCode;

    /**
     *  汇率 - T_QUOTE_DETAIL.CURR_RATE
     */
    private BigDecimal currRate;

    /**
     *  核算单价 - T_QUOTE_DETAIL.CALC_PRICE
     */
    private BigDecimal calcPrice;

    /**
     *  原币核算单价 - T_QUOTE_DETAIL.CURR_CALC_PRICE
     */
    private BigDecimal currCalcPrice;

    /**
     *  报价单价 - T_QUOTE_DETAIL.QUOTE_PRICE
     */
    private BigDecimal quotePrice;

    /**
     *  原币报价单价 - T_QUOTE_DETAIL.CURR_QUOTE_PRICE
     */
    private BigDecimal currQuotePrice;

    /**
     *  核算金额 - T_QUOTE_DETAIL.CALC_AMT
     */
    private BigDecimal calcAmt;

    /**
     *  原币核算金额 - T_QUOTE_DETAIL.CURR_CALC_AMT
     */
    private BigDecimal currCalcAmt;

    /**
     *  报价金额 - T_QUOTE_DETAIL.QUOTE_AMT
     */
    private BigDecimal quoteAmt;

    /**
     *  原币报价金额 - T_QUOTE_DETAIL.CURR_QUOTE_AMT
     */
    private BigDecimal currQuoteAmt;

    /**
     *  客户金额 - T_QUOTE_DETAIL.CUST_AMT
     */
    private BigDecimal custAmt;

    /**
     *  原币客户金额 - T_QUOTE_DETAIL.CURR_CUST_AMT
     */
    private BigDecimal currCustAmt;

    /**
     *  赠送数量 - T_QUOTE_DETAIL.FORFREE_QTY
     */
    private Long forfreeQty;

    /**
     *  送检数量 - T_QUOTE_DETAIL.FORCHECK_QTY
     */
    private Long forcheckQty;

    /**
     *  存样数量 - T_QUOTE_DETAIL.FORKEEP_QTY
     */
    private Long forkeepQty;

    /**
     *  客样数量 - T_QUOTE_DETAIL.FORCUSTSAMPLE_QTY
     */
    private Long forcustsampleQty;

    /**
     *  正数 产品总数 - T_QUOTE_DETAIL.MANU_QTY
     */
    private Long manuQty;

    /**
     *  赠送/加放 - T_QUOTE_DETAIL.FREE_FLAG
     */
    private Short freeFlag;

    /**
     *  成品单位 - T_QUOTE_DETAIL.PROD_UOM
     */
    private String prodUom;

    /**
     *  分单中数量 - T_QUOTE_DETAIL.DISTING_QTY
     */
    private Long distingQty;

    /**
     *  已分单数量 - T_QUOTE_DETAIL.DIST_QTY
     */
    private Long distQty;

    /**
     *  是否数量拆分 0-否，1-是 - T_QUOTE_DETAIL.QTY_SPLIT_FLAG
     */
    private Short qtySplitFlag;

    /**
     *  样书类型 - T_QUOTE_DETAIL.SAMPLE_TYPE
     */
    private String sampleType;

    /**
     *  包装方式 - T_QUOTE_DETAIL.PACKAGE_TYPE
     */
    private String packageType;

    /**
     *  手工包装类型 - T_QUOTE_DETAIL.MANU_PACK_TYPE
     */
    private String manuPackType;

    /**
     *  要求交期 - T_QUOTE_DETAIL.DUE_DATE
     */
    private Date dueDate;

    /**
     *  交货地址ID - T_QUOTE_DETAIL.DELI_ADDR_ID
     */
    private Long deliAddrId;

    /**
     *  交货地址描述 - T_QUOTE_DETAIL.DELI_ADDR_DESC
     */
    private String deliAddrDesc;

    /**
     *  交货方式 - T_QUOTE_DETAIL.DELI_METHOD
     */
    private String deliMethod;

    /**
     *  总印张数 - T_QUOTE_DETAIL.IMPRESSION_CNT
     */
    private Long impressionCnt;

    /**
     *  印刷完成张数 - T_QUOTE_DETAIL.PRINT_COMP_CNT
     */
    private Long printCompCnt;

    /**
     *  装订完成数 - T_QUOTE_DETAIL.BIND_COMP_CNT
     */
    private Long bindCompCnt;

    /**
     *  生产完成日期 - T_QUOTE_DETAIL.MANU_COMP_DATE
     */
    private Date manuCompDate;

    /**
     *  已入库数量 - T_QUOTE_DETAIL.WHIN_QTY
     */
    private Long whinQty;

    /**
     *  已发货数量 - T_QUOTE_DETAIL.DELI_QTY
     */
    private Long deliQty;

    /**
     *  最后发货日期 - T_QUOTE_DETAIL.LAST_DELI_DATE
     */
    private Date lastDeliDate;

    /**
     *  结算标记 未结算/已结算 - T_QUOTE_DETAIL.SETTLE_FLAG
     */
    private String settleFlag;

    /**
     *  已结算数量 - T_QUOTE_DETAIL.SETTLE_QTY
     */
    private Long settleQty;

    /**
     *  已结算金额 - T_QUOTE_DETAIL.SETTLE_AMT
     */
    private BigDecimal settleAmt;

    /**
     *  原币已结算金额 - T_QUOTE_DETAIL.CURR_SETTLE_AMT
     */
    private BigDecimal currSettleAmt;

    /**
     *  已开票金额 - T_QUOTE_DETAIL.INV_AMT
     */
    private BigDecimal invAmt;

    /**
     *  已回款金额 - T_QUOTE_DETAIL.RECV_AMT
     */
    private BigDecimal recvAmt;

    /**
     *  仓库ID - T_QUOTE_DETAIL.WH_ID
     */
    private Long whId;

    /**
     *  取消日期 - T_QUOTE_DETAIL.CANCLE_DATE
     */
    private Date cancleDate;

    /**
     *  纸张是否到位 - T_QUOTE_DETAIL.PAPER_READY_FLAG
     */
    private Short paperReadyFlag;

    /**
     *  备注 - T_QUOTE_DETAIL.REMARK
     */
    private String remark;

    /**
     *  锁定人ID - T_QUOTE_DETAIL.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_QUOTE_DETAIL.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_QUOTE_DETAIL.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_QUOTE_DETAIL.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_QUOTE_DETAIL.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_QUOTE_DETAIL.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_QUOTE_DETAIL.DATA_VERSION
     */
