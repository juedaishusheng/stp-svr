...
public class TOrgPart implements Serializable {
    /**
     *  null - T_ORG_PART.ID
     */
    private Long id;
    ...
    /**
     *  产品ID 对应T_PROD.ID - T_ORG_PART.PROD_ID
     */
    private Long prodId;

    /**
     *  行号 - T_ORG_PART.LINE_NO
     */
    private Long lineNo;

    /**
     *  部件类型 - T_ORG_PART.PART_TYPE
     */
    private String partType;

    /**
     *  部件号 - T_ORG_PART.PART_CODE
     */
    private String partCode;

    /**
     *  部件名称 - T_ORG_PART.PART_NAME
     */
    private String partName;

    /**
     *  P数 - T_ORG_PART.PAGE_CNT
     */
    private Long pageCnt;

    /**
     *  正面色数 - T_ORG_PART.COLORCNT_FRONT
     */
    private Short colorcntFront;

    /**
     *  背面色数 - T_ORG_PART.COLORCNT_BACK
     */
    private Short colorcntBack;

    /**
     *  正面专色数 - T_ORG_PART.SCOLORCNT_FRONT
     */
    private Short scolorcntFront;

    /**
     *  背面专色数 - T_ORG_PART.SCOLORCNT_BACK
     */
    private Short scolorcntBack;

    /**
     *  专色号 - T_ORG_PART.SCOLORCNT_CODE
     */
    private Short scolorcntCode;

    /**
     *  部件高度 - T_ORG_PART.PART_HEIGHT
     */
    private Short partHeight;

    /**
     *  部件宽度 - T_ORG_PART.PART_WIDTH
     */
    private Short partWidth;

    /**
     *  部件深度 - T_ORG_PART.PART_DEPTH
     */
    private Short partDepth;

    /**
     *  展开高度 - T_ORG_PART.FULL_HEIGHT
     */
    private Short fullHeight;

    /**
     *  展开宽度 - T_ORG_PART.FULL_WIDTH
     */
    private Short fullWidth;

    /**
     *  联数 - T_ORG_PART.JOIN_CNT
     */
    private Long joinCnt;

    /**
     *  工艺要求 - T_ORG_PART.PROCESS_DEMAND
     */
    private String processDemand;

    /**
     *  纸张来源 - T_ORG_PART.PAPER_SOURCE
     */
    private String paperSource;

    /**
     *  纸张料号ID - T_ORG_PART.PAPER_ITEM_ID
     */
    private Long paperItemId;

    /**
     *  纸张规格ID - T_ORG_PART.PAPER_SPEC_ID
     */
    private Long paperSpecId;

    /**
     *  纸张克重 - T_ORG_PART.PAPER_WEIGHT
     */
    private String paperWeight;

    /**
     *  纸张种类 - T_ORG_PART.PAPER_TYPE
     */
    private String paperType;

    /**
     *  纸张品牌 - T_ORG_PART.PAPER_BRAND
     */
    private String paperBrand;

    /**
     *  纸张高度 - T_ORG_PART.PAPER_HEIGHT
     */
    private Short paperHeight;

    /**
     *  纸张宽度 - T_ORG_PART.PAPER_WIDTH
     */
    private Short paperWidth;

    /**
     *  是否客来 - T_ORG_PART.CUST_SUPPLY_FLAG
     */
    private Short custSupplyFlag;

    /**
     *  是否装订 - T_ORG_PART.BIND_INCLUDE_FLAG
     */
    private Short bindIncludeFlag;

    /**
     *  原色说明 - T_ORG_PART.COLOR_DESC
     */
    private String colorDesc;

    /**
     *  专色说明 - T_ORG_PART.SCOLOR_DESC
     */
    private String scolorDesc;

    /**
     *  加工难度等级 - T_ORG_PART.DIFF_LEVEL
     */
    private String diffLevel;

    /**
     *  表面处理要求 - T_ORG_PART.SURFACE_DEMAND
     */
    private String surfaceDemand;

    /**
     *  印刷类型 平张/轮转 - T_ORG_PART.PRINT_TYPE
     */
    private String printType;

    /**
     *  纸张厂家 - T_ORG_PART.PAPER_VENDOR
     */
    private String paperVendor;

    /**
     *  纸张等级 - T_ORG_PART.PAPER_GRADE
     */
    private String paperGrade;

    /**
     *  核算用量 - T_ORG_PART.CALC_PAPERUSAGE
     */
    private BigDecimal calcPaperusage;

    /**
     *  客户要求用量 - T_ORG_PART.CUSTAGREE_PAPERUSAGE
     */
    private BigDecimal custagreePaperusage;

    /**
     *  备注 - T_ORG_PART.REMARK
     */
    private String remark;

    /**
     *  锁定人ID - T_ORG_PART.LOCKER_ID
     */
    private Long lockerId;

    /**
     *  锁定时间戳 - T_ORG_PART.LOCK_TS
     */
    private Date lockTs;

    /**
     *  修改人ID - T_ORG_PART.MODIFYER_ID
     */
    private Long modifyerId;

    /**
     *  修改时间戳 - T_ORG_PART.MODIFY_TS
     */
    private Date modifyTs;

    /**
     *  修改APPSERVER - T_ORG_PART.MODIFY_APPSVR
     */
    private String modifyAppsvr;

    /**
     *  修改模块 - T_ORG_PART.MODIFY_MODULE
     */
    private String modifyModule;

    /**
     *  数据版本号 - T_ORG_PART.DATA_VERSION
     */
